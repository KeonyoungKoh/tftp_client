...
#include "update_interface/srv/detail/firmware_update__rosidl_typesupport_fastrtps_c.h"
...
#include "update_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _FirmwareUpdate_Request__ros_msg_type = update_interface__srv__FirmwareUpdate_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_update_interface
size_t get_serialized_size_update_interface__srv__FirmwareUpdate_Request(
  const void * untyped_ros_message,
...
static uint32_t _FirmwareUpdate_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_update_interface__srv__FirmwareUpdate_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_update_interface
size_t max_serialized_size_update_interface__srv__FirmwareUpdate_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_update_interface__srv__FirmwareUpdate_Request(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_FirmwareUpdate_Request = {
  "update_interface::srv",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, update_interface, srv, FirmwareUpdate_Request)() {
...
using _FirmwareUpdate_Response__ros_msg_type = update_interface__srv__FirmwareUpdate_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_update_interface
size_t get_serialized_size_update_interface__srv__FirmwareUpdate_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FirmwareUpdate_Response__ros_msg_type * ros_message = static_cast<const _FirmwareUpdate_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_update_interface__srv__FirmwareUpdate_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_update_interface
size_t max_serialized_size_update_interface__srv__FirmwareUpdate_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_update_interface__srv__FirmwareUpdate_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, update_interface, srv, FirmwareUpdate_Response)() {
...
// already included above
// #include "update_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "update_interface/srv/firmware_update.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, update_interface, srv, FirmwareUpdate)() {
