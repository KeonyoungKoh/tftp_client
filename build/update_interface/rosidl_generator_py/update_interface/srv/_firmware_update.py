...
class Metaclass_FirmwareUpdate_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('update_interface')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_FirmwareUpdate(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'update_interface.srv.FirmwareUpdate')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from update_interface.srv import _firmware_update
...
class FirmwareUpdate(metaclass=Metaclass_FirmwareUpdate):
    from update_interface.srv._firmware_update import FirmwareUpdate_Request as Request
    from update_interface.srv._firmware_update import FirmwareUpdate_Response as Response
