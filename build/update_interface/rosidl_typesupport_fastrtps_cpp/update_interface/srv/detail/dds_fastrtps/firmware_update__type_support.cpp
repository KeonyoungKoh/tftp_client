...
#include "update_interface/srv/detail/firmware_update__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_update_interface
cdr_serialize(
  const update_interface::srv::FirmwareUpdate_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  update_interface::srv::FirmwareUpdate_Request & ros_message)
{
  // Member: will_update
  cdr >> ros_message.will_update;
...
{
  auto typed_message =
    static_cast<const update_interface::srv::FirmwareUpdate_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<update_interface::srv::FirmwareUpdate_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_update_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<update_interface::srv::FirmwareUpdate_Request>()
{
  return &update_interface::srv::typesupport_fastrtps_cpp::_FirmwareUpdate_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, update_interface, srv, FirmwareUpdate_Request)() {
  return &update_interface::srv::typesupport_fastrtps_cpp::_FirmwareUpdate_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_update_interface
cdr_serialize(
  const update_interface::srv::FirmwareUpdate_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  update_interface::srv::FirmwareUpdate_Response & ros_message)
{
  // Member: success
  cdr >> ros_message.success;
...
{
  auto typed_message =
    static_cast<const update_interface::srv::FirmwareUpdate_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<update_interface::srv::FirmwareUpdate_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &update_interface::srv::typesupport_fastrtps_cpp::_FirmwareUpdate_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, update_interface, srv, FirmwareUpdate_Response)() {
  return &update_interface::srv::typesupport_fastrtps_cpp::_FirmwareUpdate_Response__handle;
}
...
{
  return &update_interface::srv::typesupport_fastrtps_cpp::_FirmwareUpdate__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, update_interface, srv, FirmwareUpdate)() {
  return &update_interface::srv::typesupport_fastrtps_cpp::_FirmwareUpdate__handle;
}
