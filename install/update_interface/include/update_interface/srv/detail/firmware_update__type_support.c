...
#include <stddef.h>
#include "update_interface/srv/detail/firmware_update__rosidl_typesupport_introspection_c.h"
#include "update_interface/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  update_interface__srv__FirmwareUpdate_Request__init(message_memory);
}
...
{
  update_interface__srv__FirmwareUpdate_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember FirmwareUpdate_Request__rosidl_typesupport_introspection_c__FirmwareUpdate_Request_message_member_array[3] = {
  {
    ...
    offsetof(update_interface__srv__FirmwareUpdate_Request, will_update),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(update_interface__srv__FirmwareUpdate_Request, host),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(update_interface__srv__FirmwareUpdate_Request, filename),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers FirmwareUpdate_Request__rosidl_typesupport_introspection_c__FirmwareUpdate_Request_message_members = {
  "update_interface__srv",  // message namespace
  "FirmwareUpdate_Request",  // message name
  3,  // number of fields
  sizeof(update_interface__srv__FirmwareUpdate_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_update_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, update_interface, srv, FirmwareUpdate_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  update_interface__srv__FirmwareUpdate_Response__init(message_memory);
}
...
{
  update_interface__srv__FirmwareUpdate_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember FirmwareUpdate_Response__rosidl_typesupport_introspection_c__FirmwareUpdate_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(update_interface__srv__FirmwareUpdate_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers FirmwareUpdate_Response__rosidl_typesupport_introspection_c__FirmwareUpdate_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(update_interface__srv__FirmwareUpdate_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_update_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, update_interface, srv, FirmwareUpdate_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers update_interface__srv__detail__firmware_update__rosidl_typesupport_introspection_c__FirmwareUpdate_service_members = {
  "update_interface__srv",  // service namespace
  "FirmwareUpdate",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // update_interface__srv__detail__firmware_update__rosidl_typesupport_introspection_c__FirmwareUpdate_Request_message_type_support_handle,
  NULL  // response message
  // update_interface__srv__detail__firmware_update__rosidl_typesupport_introspection_c__FirmwareUpdate_Response_message_type_support_handle
};

static rosidl_service_type_support_t update_interface__srv__detail__firmware_update__rosidl_typesupport_introspection_c__FirmwareUpdate_service_type_support_handle = {
  0,
  &update_interface__srv__detail__firmware_update__rosidl_typesupport_introspection_c__FirmwareUpdate_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, update_interface, srv, FirmwareUpdate)() {
  if (!update_interface__srv__detail__firmware_update__rosidl_typesupport_introspection_c__FirmwareUpdate_service_type_support_handle.typesupport_identifier) {
    update_interface__srv__detail__firmware_update__rosidl_typesupport_introspection_c__FirmwareUpdate_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)update_interface__srv__detail__firmware_update__rosidl_typesupport_introspection_c__FirmwareUpdate_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, update_interface, srv, FirmwareUpdate_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, update_interface, srv, FirmwareUpdate_Response)()->data;
  }

  return &update_interface__srv__detail__firmware_update__rosidl_typesupport_introspection_c__FirmwareUpdate_service_type_support_handle;
}
