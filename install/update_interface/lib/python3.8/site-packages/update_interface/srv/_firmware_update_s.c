...
bool update_interface__srv__firmware_update__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("update_interface.srv._firmware_update.FirmwareUpdate_Request", full_classname_dest, 60) == 0);
  }
  update_interface__srv__FirmwareUpdate_Request * ros_message = _ros_message;
  {  // will_update
...
PyObject * update_interface__srv__firmware_update__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("update_interface.srv._firmware_update");
...
ROSIDL_GENERATOR_C_EXPORT
bool update_interface__srv__firmware_update__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("update_interface.srv._firmware_update.FirmwareUpdate_Response", full_classname_dest, 61) == 0);
  }
  update_interface__srv__FirmwareUpdate_Response * ros_message = _ros_message;
  {  // success
