...
{
  new (message_memory) tftp_update::srv::FirmwareUpdate_Request(_init);
}

void FirmwareUpdate_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tftp_update::srv::FirmwareUpdate_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FirmwareUpdate_Request_message_member_array[3] = {
  {
    ...
    offsetof(tftp_update::srv::FirmwareUpdate_Request, will_update),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tftp_update::srv::FirmwareUpdate_Request, host),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tftp_update::srv::FirmwareUpdate_Request, filename),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FirmwareUpdate_Request_message_members = {
  "tftp_update::srv",  // message namespace
  "FirmwareUpdate_Request",  // message name
  3,  // number of fields
  sizeof(tftp_update::srv::FirmwareUpdate_Request),
...
{
  return &::tftp_update::srv::rosidl_typesupport_introspection_cpp::FirmwareUpdate_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tftp_update, srv, FirmwareUpdate_Request)() {
  return &::tftp_update::srv::rosidl_typesupport_introspection_cpp::FirmwareUpdate_Request_message_type_support_handle;
}
...
void FirmwareUpdate_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) tftp_update::srv::FirmwareUpdate_Response(_init);
}

void FirmwareUpdate_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tftp_update::srv::FirmwareUpdate_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FirmwareUpdate_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tftp_update::srv::FirmwareUpdate_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FirmwareUpdate_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(tftp_update::srv::FirmwareUpdate_Response),
...
{
  return &::tftp_update::srv::rosidl_typesupport_introspection_cpp::FirmwareUpdate_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tftp_update, srv, FirmwareUpdate_Response)() {
  return &::tftp_update::srv::rosidl_typesupport_introspection_cpp::FirmwareUpdate_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers FirmwareUpdate_service_members = {
  "tftp_update::srv",  // service namespace
  "FirmwareUpdate",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<tftp_update::srv::FirmwareUpdate>()
...
get_service_type_support_handle<tftp_update::srv::FirmwareUpdate>()
{
  ...
  auto service_type_support =
    &::tftp_update::srv::rosidl_typesupport_introspection_cpp::FirmwareUpdate_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tftp_update, srv, FirmwareUpdate)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<tftp_update::srv::FirmwareUpdate>();
}
